...
# NOTE (owner ruling 2026-09-14, D4): model-behavior probes do not belong
# in this suite — the models are static pinned artifacts outside our
# control, so asserting on their behavior adds no value. The echo and
# collapse probes live as reporting-only scripts under
# tests/benchmark/ (probe_echo.py, probe_collapse.py): run manually,
# exit 0 always, news-not-failure. Do not re-add model assertions here.
